...
describe('readDirectory()', () => {
    context('target directory contains child directories', () => {
        it('gets names of the children directories', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-directories'));
    ...
    context('target directory contains child directories that do not contain index', () => {
        it('gets names of the children directories', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-directories-without-index'));
    ...
    context('target directory contains child directories (unsafe name)', () => {
        it('gets names of the children directories', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-directories-unsafe-name'));
    ...
    context('target directory contains ./index.js', () => {
        it('does not include ./index.js', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-index'));
    ...
    context('target directory contains files', () => {
        it('refers to the files (with extension)', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-files'));
    ...
    context('target directory contains dot files', () => {
        it('ignores files', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-dot-files'));
    ...
    context('target directory contains files with no extension', () => {
        it('ignores files', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-files-no-extension'));
    ...
    context('target directory contains files with multiple extensions', () => {
        it('ignores files', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-files-multiple-extensions'));
    ...
    context('target directory contains directories and files with the same name', () => {
        it('prefers file', () => {
            ...
            names = readDirectory(path.resolve(fixturesPath, 'children-directories-and-files'));
